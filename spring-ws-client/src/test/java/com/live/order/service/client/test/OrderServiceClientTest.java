...
import com.liverestaurant.orderservice.schema.Address;
import com.liverestaurant.orderservice.schema.Customer;
import com.liverestaurant.orderservice.schema.FoodItem;
import com.liverestaurant.orderservice.schema.FoodItemType;
import com.liverestaurant.orderservice.schema.Name;
...
public class OrderServiceClientTest {
    ...
    private List<FoodItem> prepareOrderItems() {
        ...
        items.add(prepareFoodItem("Vegetable Thali", FoodItemType.MEALS, 2));
